...
// void main() => runApp(MaterialApp(home: Container()));
...
class _WebViewExampleState extends State<WebViewExample> {
  ...
  void initState() {
    ...
    controller = WebViewController.fromPlatform(JnigenWebViewController())
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: WebViewWidget.fromPlatform(
          platform: JnigenWebViewWidget(
